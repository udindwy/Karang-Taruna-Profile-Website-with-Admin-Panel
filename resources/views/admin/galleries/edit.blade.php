                        ...
                        <div class="mb-6">
                            ...
                            @if ($gallery->image)
                                <div class="mt-4">
                                    ...
                                    <img src="{{ asset('storage/' . $gallery->image) }}" alt="{{ $gallery->caption }}" class="w-24 h-24 object-cover mt-2 rounded-lg shadow-md">
                                </div>
                            @endif
                        </div>
                        <div class="mb-6">
                            <label for="caption" class="block text-gray-700 font-bold mb-2">Caption (Opsional)</label>
                            <input type="text" name="caption" id="caption" class="shadow appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-900 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ old('caption', $gallery->caption) }}">
                        </div>
