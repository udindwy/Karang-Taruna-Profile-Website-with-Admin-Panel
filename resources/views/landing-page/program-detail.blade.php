...
<head>
    ...
    <title>{{ $program->title }} | {{ $setting->site_name ?? 'Karang Taruna' }}</title>
    ...
    <main>
        ...
        <header class="bg-blue-600 text-white pt-32 pb-24">
            <div class="container mx-auto px-4 md:px-8 max-w-4xl" data-aos="fade-up">
                <nav class="text-sm font-semibold text-blue-200 mb-6">
                    ...
                    <a href="{{ route('programs.index') }}" class="hover:text-white">Program</a>
                    <span class="mx-2">/</span>
                    <span class="text-white">{{ Str::limit($program->title, 30) }}</span>
                </nav>
                ...
                <div class="flex items-center space-x-4 mt-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-200">
                            Dipublikasikan pada {{ $program->created_at->translatedFormat('d F Y') }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white pt-12 pb-16">
            <div class="container mx-auto px-4 md:px-8 max-w-4xl">
                ...
                {{-- [BARU] Tombol Share ditambahkan di sini --}}
                <div class="py-4 border-y border-slate-200 mb-8" data-aos="fade-up" data-aos-delay="200">
                    <div x-data="{ shareLink: '{{ url()->current() }}', shareTitle: '{{ urlencode($program->title) }}' }" class="flex items-center space-x-4">
                        ...
                        <a :href="'https: //api.whatsapp.com/send?text=' + shareTitle + ' ' + shareLink"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <aside class="lg:col-span-1" data-aos="fade-up" data-aos-delay="300">
                        <div class="sticky top-28">
                            <h3 class="text-xl font-bold text-slate-900 mb-4 pb-3 border-b border-slate-200">Program
                                Terkait</h3>
                            <ul class="space-y-4">
                                @forelse ($otherPrograms as $other)
                                    <li>
                                        <a href="{{ route('program.show', $other) }}"
                                ...
                                @empty
                                    <li>
                                        <p class="text-slate-500">Tidak ada program lain.</p>
                                    </li>
                                @endforelse
                            </ul>
                        </div>
